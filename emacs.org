...
Disabled: bookmark+ is no longer available from melpa:
https://www.reddit.com/r/emacs/comments/ig7736/whatever_happened_to_bookmark/
#+BEGIN_SRC emacs-lisp :tangle no
...
** Configure a guile binary using Guix
In order to get a reproducible environment, I am running guile in a guix environment. Using a simple wrapper script as a start:
#+begin_src shell tangle: no
  #!/bin/bash
  # https://unix.stackexchange.com/questions/761784/how-to-get-guix-perfect-setup-to-work
  guix shell guile guile-readline guile-colorized -- guix repl "$@"

#+end_src

#+begin_src emacs-lisp
  (setq geiser-guile-binary "~/src/guile-repl/guix-repl.sh")
#+end_src
