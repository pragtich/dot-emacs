...
'((agenda . " %i %-12:c%?-12t% s")
 (timeline . "  % s")
 (todo . "%(concat \"[\" (org-format-outline-path (org-get-outline-path)) \"] \")")
 (tags . "%(concat \"[\" (org-format-outline-path (org-get-outline-path)) \"] \")")
 (search . " %i %-8:c"))
)) ())))       ;(settings) (files)
;  ((org-agenda-prefix-format '((todo . "%i %-12c")))) ())) ; (settings) (files)
