...
(setq pragtich/org-todo-file (car (org-agenda-files)))
#+END_SRC
** Keybindings
...
A simple capture template from [[http://pragmaticemacs.com/emacs/org-mode-basics-vi-a-simple-todo-list/][Pragmatic emacs]]. Let's try it.
#+BEGIN_SRC emacs-lisp
